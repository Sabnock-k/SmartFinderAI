            ...
            {!isSubmitted ? (
                  ...
                  {loading ? (
                    ...
                    <>
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 12v4m0 0v4m0-4h4m-4 0h-4m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                      </svg>
                      Send reset link
                    </>
                  )}
              ...
              <div className="text-center">
                ...
                <p className="text-gray-700 text-sm mb-6">
                  We've sent a password reset link to <strong className="text-[#1a237e]">{email}</strong>
                </p>
          ...
          <div className="mt-6 text-center">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-gray-600">Remember your password?</span>
              </div>
            </div>
            <div className="mt-4">
              <a
